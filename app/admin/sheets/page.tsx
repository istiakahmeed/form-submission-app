    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage your form sheets and customize field headers</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Sheet Manager</CardTitle>
            <CardDescription>Create and configure different sheets for your form submissions</CardDescription>
          </CardHeader>
          <CardContent>
